...
func (m *MockBscExecutor) GetBlockAndPackages(height int64) (*common.BlockAndPackageLogs, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBlockAndTxEvents", height)
...
func (mr *MockBscExecutorMockRecorder) GetBlockAndPackages(height interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBlockAndTxEvents", reflect.TypeOf((*MockBscExecutor)(nil).GetBlockAndPackages), height)
}
